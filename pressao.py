...
distancia_vlo = fuzz.gaussmf(x_distancia, 0, 8)
distancia_lo = fuzz.gaussmf(x_distancia, 25, 8)
distancia_md = fuzz.gaussmf(x_distancia, 50, 8)
distancia_hi = fuzz.gaussmf(x_distancia, 75, 8)
distancia_vhi = fuzz.gaussmf(x_distancia, 100, 8)
velocidade_vlo = fuzz.gaussmf(x_velocidade,  0, 8)
velocidade_lo = fuzz.gaussmf(x_velocidade,  25, 8)
velocidade_md = fuzz.gaussmf(x_velocidade,  50, 8)
velocidade_hi = fuzz.gaussmf(x_velocidade,  75, 8)
velocidade_vhi = fuzz.gaussmf(x_velocidade,  100, 8)
pressao_vlo = fuzz.gaussmf(x_pressao, 0, 8)
pressao_lo = fuzz.gaussmf(x_pressao, 25, 8)
pressao_md = fuzz.gaussmf(x_pressao, 50, 8)
pressao_hi = fuzz.gaussmf(x_pressao, 75, 8)
pressao_vhi = fuzz.gaussmf(x_pressao, 100, 8)
